...
[[ -f bs2built.bin ]] && mv -f bs2built.bin bs2built.prev.bin
...
[[ -f s2.p ]] && bin/s2p2bin $s2p2bin_args s2.p bs2built.bin s2.h
[[ -f bs2built.bin ]] && bin/fixpointer s2.h bs2built.bin   off_3A294 MapRUnc_Sonic \$2D 0 4   word_728C_user Obj5F_MapUnc_7240 2 2 1
[[ -f bs2built.bin ]] && bin/fixheader bs2built.bin
